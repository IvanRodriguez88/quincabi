				...
				@foreach($suppliers as $supplier)
					<tr>
						...
						<td class="text-center">
							<a class="btn btn-primary" onclick="getAddEditModal('edit', {{$supplier->id}})">
								<i class="fas fa-edit"></i>
							</a>
							<a class="btn btn-danger" onclick="showDelete({{$supplier->id}}, '{{$supplier->name}}')">
...
@section('js')
	@vite(['resources/js/generalFunctions.js', 'resources/js/sweetAlert.js', 'resources/js/suppliers.js'])
@stop
