...
@section('content')
	...
	<x-adminlte-card>
		...
		<div class="card-body">
            ...
            <p class="mb-1">Total: <b>${{formatNumber($invoice->getTotal())}}</b></p>
            <p class="mb-1">Total payments: <b>${{formatNumber($invoice->getTotalPayments())}}</b></p>
            <p class="mb-1">Rest: <b>${{formatNumber($invoice->getTotal() - $invoice->getTotalPayments() )}}</b></p>
