...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('materials', function (Blueprint $table) {
			...
			$table->string('extra_name')->nullable()->comment('Nombre adicional o comentario extra al nombre construido');

			$table->float('cost')->default(0)->comment('Si no lo agrega por default es 0');
			$table->float('price')->default(0)->comment('Si no lo agrega por default es 0');
